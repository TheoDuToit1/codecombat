...
export const CS1_LESSONS = [
  ...
  },
  {
    ...
    difficulty: 1,
    estimatedTime: 10,
    hints: ["Use hero.moveRight() with a number to move multiple steps", "Count how many steps to reach the potion", "The potion is 8 steps to the right"],
    unlocks: "",
    week: 1,
    mentor: { name: "Sage the Wizard", icon: "🧙" },
  },
  {
    ...
    codeExample: "hero.moveUp(5)\nhero.moveRight(5)",
    goals: ["Move in multiple directions", "Collect two different gems", "Plan a multi-step path"],
    concept: "Multi-Direction",
    difficulty: 1,
    estimatedTime: 15,
    hints: ["First go up to get the blue gem", "Then go right to get the red gem", "Use two movement commands with the right numbers"],
    unlocks: "",
    week: 1,
    mentor: { name: "Sage the Wizard", icon: "🧙" },
  },
  {
    ...
    difficulty: 2,
    estimatedTime: 20,
    hints: ["Plan your complete path before writing code", "Remember to return to your starting point between gems", "You need to use all four directions"],
    unlocks: "",
    week: 1,
    mentor: { name: "Sage the Wizard", icon: "🧙" },
  },
